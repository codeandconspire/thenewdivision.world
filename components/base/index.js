...
function icon (icon, opts = {}) {
  ...
  return html`
    <svg class="${opts.class}" role="presentation" width="${select.size}" height="${select.size}" viewBox="0 0 ${select.size} ${select.size}" style="${select.fix ? 'position: relative; top: 0.125rem; left: 0.1875rem' : ''}">
