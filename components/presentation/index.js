    ...
    return html`
      <div class="Presentation ${this.static ? 'Presentation--static' : ''}" id="${this.id.replace(/[^\w]+/g, '-')}">
        <div class="Presentation-col" style="flex-basis: ${((167 / SIZE) * 100).toFixed(2)}%">
          ...
          <a class="Presentation-link Presentation-link--tilted" onclick=${scrollIntoView} href="#about">${text`Read more`}</a>
        </div>
        <div class="Presentation-col" style="flex-basis: ${((374 / SIZE) * 100).toFixed(2)}%">
          ...
          <a class="Presentation-link Presentation-link--tilted" onclick=${scrollIntoView} href="#services">${text`Read more`}</a>
        </div>
        <div class="Presentation-col" style="flex-basis: ${((285 / SIZE) * 100).toFixed(2)}%">
          ...
          <a class="Presentation-link Presentation-link--tilted" onclick=${scrollIntoView} href="#process">${text`Read more`}</a>
        </div>
        <div class="Presentation-col" style="flex-basis: ${((376 / SIZE) * 100).toFixed(2)}%">
          ...
          <a class="Presentation-link Presentation-link--tilted" onclick=${scrollIntoView} href="#clients">${text`Read more`}</a>
        </div>
      </div>
    `
  }
