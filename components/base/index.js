...
function icon (icon, attrs) {
  ...
  return html`
    <svg ${attrs} role="presentation" width="${select.size}" height="${select.size}" viewBox="0 0 ${select.size} ${select.size}">
