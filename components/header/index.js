...
const { a, icon, resolve, className } = require('../base')
...
module.exports = class Header extends Component {
  ...
  static placeholder () {
    return html`<header class="Header u-container"></header>`
  }
  ...
  load (el) {
    const menu = el.querySelector('.js-menu')
  ...
  createElement (data) {
    const { emit, state, local, text } = this
    ...
    return html`
      <header class="Header u-container" id="${local.id}">
        <nav class="Header-wrap">
          <a class="Header-logo" href="/${state.language === 'en' ? '' : state.language}" rel="home">
